...
class Bird(pg.sprite.Sprite):
    def __init__(self,scale_factor):
        ...
        self.img_list = [pg.transform.scale_by (pg.image.load("Assets/sprites/birdup.png").convert_alpha(),scale_factor),
                         pg.transform.scale_by (pg.image.load("Assets/sprites/birddown.png").convert_alpha(),scale_factor)]
